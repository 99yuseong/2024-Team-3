...
struct MotionPracticeView: View {
    ...
    var body: some View {
        ...
        .onChange(of: motionManager.isDetected(type: action.type)) {
            ...
            if count == 0 {
                ...
                NavigationManager.shared.push(to: .motionPracticeFinish(actionModel: action))
            }
        }
        .onAppear {
...
#Preview {
    MotionPracticeView(action: ActionModel.details.first!)
}
